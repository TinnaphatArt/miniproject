 ...
 * โครงงาน: การพัฒนาเว็บแอปพลิเคชันสำหรับประเมินและแนะนำการปรับปรุงเว็บไซต์เพื่อผู้พิการตามมาตรฐาน WCAG เบื้องต้น
 *
...
function testAppendRow() {
  var sample = {
    ...
    /* ค่าที่ใช้ได้คือ pass, improve และ fail ตามเกณฑ์สามระดับในบทที่ 3.8 */
    checklist: { 'CL-1.1.1': 'pass', 'CL-1.3.1': 'improve', 'CL-1.4.3': 'fail' },
    toolVersion: '1.0.0'
  };
